...
pub struct LevelFilterArg(pub LevelFilter);
...
pub struct Opt {
    ...
    pub output_config_file: Option<PathBuf>,
    ...
    pub keep_dir: Vec<String>,
    #[arg(long, value_name = "PATH")]
    pub path_mapping: Option<PathBuf>,
    ...
    pub sort_output_types: Vec<OutputType>,
    ...
    pub service_flag_name: Option<String>,
